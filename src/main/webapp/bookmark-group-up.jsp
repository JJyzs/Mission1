...
<body>
	...
	<form action="bookmark-group-up-ex.jsp" method="post">
		<tr><th>북마크 이름</th> 
	...
	<input type="hidden" name="ID" value="<%=id %>">
		<td colspan="2" align="center" ><a href="bookmark-group.jsp">돌아가기</a> | <button type="submit" onclick="show()">수정</button></td>
	</form>
	</table>
